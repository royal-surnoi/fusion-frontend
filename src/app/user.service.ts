...
export class UserService {
  ...
  private apiBaseUrl = 'http://54.162.40.172:8080';
  // private apiUrl = 'http://54.162.40.172:8080/user/all';
  // private apiUrl = 'http://54.162.40.172:8080/user/all';
  private apiUrl = 'http://54.162.40.172:8080/suggestFriendsRecommendations'
 
  private incrementUrl = 'http://54.162.40.172:8080/follow/incrementCounts';
  private decrementUrl = 'http://54.162.40.172:8080/follow/decrementCounts';
  private followUrl = 'http://54.162.40.172:8080/follow/saveByIds';
  private apiUrll = 'http://54.162.40.172:8080/api/users';
 
 private followRequestsUrl = 'http://54.162.40.172:8080/follow/zero-followers-following/followings'
 ...
 private followedUsersSubject = new BehaviorSubject<number[]>([]);
  ...
  removeFollower(followerId: number, userId: number): Observable<any> {
    ...
    return this.http.delete('http://54.162.40.172:8080/follow/deleteByIds', { params }).pipe(
      tap(() => {

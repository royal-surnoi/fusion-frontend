...
=======
Run `ng serve` for a dev server. Navigate to `http://be.royalreddy.co.in:8080/`. The application will automatically reload if you change any of the source files.
